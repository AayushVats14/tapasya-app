      ...
      <div className="w-full max-w-5xl relative z-10 flex flex-col gap-6">
        <div className="mb-2">
          ...
          <p className="text-zinc-500 mt-2 text-sm">
            Manage the squads you're actively grinding with and share invite
            codes.
          </p>
        </div>
          ...
          <div className="w-full bg-[#0c0d12]/80 backdrop-blur-2xl border border-white/10 rounded-3xl p-12 text-center flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-500 text-sm mt-1 max-w-sm">
                Join a squad to study together and push each other up the global
                rankings.
              </p>
            </div>
            <button
                ...
                <div>
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-zinc-100 font-semibold text-base line-clamp-1">
                          {squad.name}
                        </h3>
